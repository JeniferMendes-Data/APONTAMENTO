...
function js_DataApontRetroativo(data, permissao) {
	...
	}else if (data == 1 || dataAtual.getDate() <= 6){ //minDate verifica se o parâmetro de lançamento retroativo no _utilitaries->config->ApontRetroativo está setado como true ou se o dia atual é anterior ao dia 5 para liberar apontamento no mês anterior
