...
function f_soap_write_coligada02($DataServerName,$XML_ENTRADA){

//-----------------------------------------------------------------------------
	$user = "fluig";
	$pass = "Arh#100121";
	$soapauth = array("login"=> $user,"password"=> $pass, "trace" => 1);
	$wsdl_DataServer = "http://192.168.0.04:8051/wsDataServer/MEX?wsdl";
	...
	$Contexto = "CODCOLIGADA=2;CODUSUARIO=fluig;CODSISTEMA=G";
