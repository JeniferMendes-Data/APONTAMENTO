...
<?php
	...
	if(is_null($result)){
      ...
      if($statuscod == '10' || $statuscod == '12' || $statuscod == '13' || $statuscod == '14' || $statuscod == '16' || $statuscod == '20'|| $statuscod == '21' || $statuscod == '22'){
		...
		header("Location: apontamentoColab.php");
		}
	}
	...
	<!--Fim teste modal-->
		<div class="wrapper d-flex align-items-stretch">
			...
			<div id="content" class="p-4 p-md-5 pt-5">
				...
				<form method="post" action='apontamentoColab.php' id="apontamentoColab" >
					...
					<div class="form-row" align="center">
						<div class="col-sm-12" >
							<div class="form-group has-warning has-feedback" >
								<input type="submit" name="apontar"  class="btn btn-primary" onclick="" tabindex="5" value="Apontar"/>
								<input type="button" name= "gerenciar" class="btn btn-primary" onclick="novoApontamento()" tabindex="5" value="Gerenciar"/>
...
<script>
function enviaDSS(){
  apontamentoColab.action = 'cadastraHoraDssColab.php';
  apontamentoColab.submit();

}
</script>
<script>
function novoApontamento(){
  apontamentoColab.action = 'gerenciaColab.php';
  apontamentoColab.submit();
}
</script>
...
function check(){
	...
	if (document.getElementById('RETRABALHO').checked == true ){
		...
		document.getElementById("INPUTCAUSARETRABALHO").selectedIndex = 'NA';
