    	...
    	<div class="container">
        		...
        		<div id="dadosLanc" class="row">
        			...
        			<div class="col-md-4">
        				...
        				<input id="inpHoraInicio" name="inpHoraInicio" type="time" class="form-control APT APV" readOnly onblur="js_ApontarValidaHora('<?php if (isset($_SESSION['APV'])){ echo $_SESSION['APV'];}else{ echo 0;} ?>', '<?php echo $_SESSION['usuarioLogado'];?>')" required></input>
        			</div>
        			<div class="col-md-2">
        			...
        			<div class="col-md-4">
        				...
        				<input id="inpHoraFim" name="inpHoraFim" type="time" class="form-control APT APV" onblur="js_ApontarValidaHora('<?php if (isset($_SESSION['APV'])){ echo $_SESSION['APV'];}else{ echo 0;} ?>', '<?php echo $_SESSION['usuarioLogado'];?>')" required readOnly></input>
        			</div>
        		</div>
